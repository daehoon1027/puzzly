...
<section><h2>3. 외부 이미지 서비스</h2><p>추천 이미지는 운영팀이 사전에 선별한 Unsplash 이미지 주소에서 불러옵니다. 사용자의 검색어 자체를 외부 이미지 서비스로 전송하지 않으며, 이미지가 표시될 때 Unsplash 서버로 이미지 요청이 전송되어 해당 제공처의 개인정보처리방침이 적용될 수 있습니다. 퍼즐리는 외부 사이트의 데이터 처리 방식을 통제하지 않습니다.</p></section>
