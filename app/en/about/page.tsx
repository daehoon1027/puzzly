...
export default function EnglishAboutPage() {
  return <InfoPage locale="en" eyebrow="ABOUT PUZZLY" title="A better way to spend time with one image" intro="Puzzly helps you find an image, choose a format and difficulty, and start a free photo puzzle right away.">
